...
console.warn('🔩 bom-functions.js v=cfgid4');
  ...
  Promise.all([
    ...
    if (configs.length) {
      ...
      configs.forEach(c => {
        ...
        pHtml += `<span class="pbs-ce-param-pill param" onclick="ceInsertText('param.cfg_${c.id}')" title="${escHtml(ptTitle)}">${paramName}${defVal ? '<span class="text-gray-400 ml-0.5">=' + escHtml(String(defVal)) + '</span>' : ''}</span>`;
      });
...
function openCellEditor(itemPk, field, currentVal, isQty, mappingId, expectedType) {
  ...
  if (field === 'variant_name' || field === 'variant_ipn') {
    ...
    title.innerHTML = (labels[field] || '🧬 编辑动态模板') + ' <span style="font-size:11px;background:#fde68a;color:#78350f;padding:2px 7px;border-radius:4px;margin-left:6px;font-family:monospace;font-weight:700;border:2px solid #d97706;white-space:nowrap">v=cfgid4</span>';
    ...
    title.innerHTML = '📐 ' + escHtml(qtyText) + ' <span style="font-size:11px;background:#fde68a;color:#78350f;padding:2px 7px;border-radius:4px;margin-left:6px;font-family:monospace;font-weight:700;border:2px solid #d97706;white-space:nowrap">v=cfgid5</span>';
    input.value = currentVal || '';
    ...
    title.innerHTML = (iconMap[field] || '✏️') + ' ' + (labels[field] || '编辑') + ' <span style="font-size:11px;background:#fde68a;color:#78350f;padding:2px 7px;border-radius:4px;margin-left:6px;font-family:monospace;font-weight:700;border:2px solid #d97706;white-space:nowrap">v=cfgid4</span>';
    input.value = currentVal || '';
...
function openFormulaEditorForVariable(mode, data) {
  ...
  // Title and button
  if (mode === 'add') {
    title.innerHTML = '📐 新建中间变量 <span style="font-size:11px;background:#fde68a;color:#78350f;padding:2px 7px;border-radius:4px;margin-left:6px;font-family:monospace;font-weight:700;border:2px solid #d97706;white-space:nowrap">v=cfgid4</span>';
    document.getElementById('pbs-ce-save-btn').innerHTML = '创建变量';
  } else {
    title.innerHTML = '✏️ 编辑变量 <span style="font-size:11px;background:#fde68a;color:#78350f;padding:2px 7px;border-radius:4px;margin-left:6px;font-family:monospace;font-weight:700;border:2px solid #d97706;white-space:nowrap">v=cfgid4</span>';

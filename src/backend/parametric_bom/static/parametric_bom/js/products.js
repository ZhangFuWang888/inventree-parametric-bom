...
console.warn('🏷️ products.js v=cfgid7');
...
function renderParamCard(cfg, idx) {
  ...
  return `<div class="param-card type-${type}"
    ...
    <div class="param-card-header">
      ...
      <span class="text-[10px] text-gray-400 font-mono ml-1 select-all" title="公式引用: param.cfg_${cfgId}">cfg_${cfgId}</span>
    </div>
